...
function adminList() {
    ...
    if (DisList == "Barguna") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Amtali Municipality">আমতলী পৌরসভা (Amtali Municipality)</option><option value="Barguna Municipality">বরগুনা পৌরসভা (Barguna Municipality)</option><option value="Betagi Municipality">বেতাগী পৌরসভা (Betagi Municipality)</option><option value="Patharghata Municipality">পাথরঘাটা পৌরসভা (Patharghata Municipality)</option>';
    }
    if (DisList == "Barishal") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Barishal City Corporation">বরিশাল সিটি কর্পোরেশন (Barishal City Corporation)</option><option value="Bakerganj Municipality">বাকেরগঞ্জ পৌরসভা (Bakerganj Municipality)</option><option value="Banaripara Municipality">বানারীপাড়া পৌরসভা (Banaripara Municipality)</option><option value="Gournadi Municipality">গৌড়নদী পৌরসভা (Gournadi Municipality)</option><option value="Mehendiganj Municipality">মেহেন্দিগঞ্জ পৌরসভা (Mehendiganj Municipality)</option><option value="Muladi Municipality">মুলাদী পৌরসভা (Muladi Municipality)</option><option value="Wazirpur Municipality">উজিরপুর পৌরসভা (Wazirpur Municipality)</option>';
    }
    if (DisList == "Bhola") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bhola Municipality">ভোলা পৌরসভা (Bhola Municipality)</option><option value="Lalmohon Municipality">লালমোহন পৌরসভা (Lalmohon Municipality)</option><option value="Char Fasson Municipality">চরফ্যাশন পৌরসভা (Char Fasson Municipality)</option><option value="Burhanuddin Municipality">বোরহান উদ্দিন পৌরসভা (Burhanuddin Municipality)</option><option value="Daulatkhan Municipality">দৌলতখান পৌরসভা (Daulatkhan Municipality)</option>';
    }
    if (DisList == "Jhalokati") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Jhalokati Municipality">ঝালকাঁঠি পৌরসভা (Jhalokati Municipality)</option><option value="Nalchity Municipality">নলছিটি পৌরসভা (Nalchity Municipality)</option>';
    }
    if (DisList == "Patuakhali") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Patuakhali Municipality">পটুয়াখালী পৌরসভা (Patuakhali Municipality)</option><option value="Galachipa Municipality">গলাচিপা পৌরসভা (Galachipa Municipality)</option><option value="Bauphal Municipality">বাউফল পৌরসভা (Bauphal Municipality)</option><option value="Kolapara Municipality">কলাপাড়া পৌরসভা (Kolapara Municipality)</option><option value="Kuakata Municipality">কুয়াকাটা পৌরসভা (Kuakata Municipality)</option>';
    }
    if (DisList == "Pirojpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Pirojpur Municipality">পিরোজপুর পৌরসভা (Pirojpur Municipality)</option><option value="Swarupkathi Municipality">স্বরূপকাঠি পৌরসভা (Swarupkathi Municipality)</option><option value="Mathbaria Municipality">মঠবাড়ীয়া পৌরসভা (Mathbaria Municipality)</option><option value="Bhandaria Municipality">ভান্ডারিয়া পৌরসভা (Bhandaria Municipality)</option>';
    }

    //Chittagong Division
    if (DisList == "Bandarban") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bandarban Municipality">বান্দরবান পৌরসভা (Bandarban Municipality)</option><option value="Lama Municipality">লামা পৌরসভা (Lama Municipality)</option>';
    }
    if (DisList == "Brahmanbaria") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Brahmanbaria Municipality">ব্রাহ্মণবাড়িয়া পৌরসভা (Brahmanbaria Municipality)</option><option value="Nabingara Municipality">নবীনগর পৌরসভা (Nabingara Municipality)</option><option value="Akhaura Municipality">আখাউড়া পৌরসভা (Akhaura Municipality)</option><option value="Kasba Municipality">কসবা পৌরসভা (Kasba Municipality)</option>';
    }
    if (DisList == "Chandpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Chandpur Municipality">চাঁদপুর পৌরসভা (Chandpur Municipality)</option><option value="Hajiganj Municipality">হাজীগঞ্জ পৌরসভা (Hajiganj Municipality)</option><option value="Kachua Municipality">কচুয়া পৌরসভা (Kachua Municipality)</option><option value="Chengaracara Municipality">ছেংগারচর পৌরসভা (Chengaracara Municipality)</option><option value="Matlab Municipality">মতলব পৌরসভা (Matlab Municipality)</option><option value="Shahrasti Municipality">শহরাস্তি পৌরসভা (Shahrasti Municipality)</option><option value="Faridganj Municipality">ফরিদগঞ্জ পৌরসভা (Faridganj Municipality)</option>';
    }
    if (DisList == "Chattogram") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Chittagong City Corporation">চট্টগ্রাম সিটি কর্পোরেশন (Chittagong City Corporation)</option><option value="Banshkhali Municipality">বাঁশখালী পৌরসভা (Banshkhali Municipality)</option><option value="Baroiyarhat Municipality">বারৈয়ারহাট পৌরসভা (Baroiyarhat Municipality)</option><option value="Boalkhali Municipality">বোয়ালখালী পৌরসভা (Boalkhali Municipality)</option><option value="Chandanaish Municipality">চন্দনাইশ পৌরসভা (Chandanaish Municipality)</option><option value="Fatikchhari Municipality">ফটিকছড়ি পৌরসভা (Fatikchhari Municipality)</option><option value="Hathazari Municipality">হাটহাজারী পৌরসভা (Hathazari Municipality)</option><option value="Mirsharai Municipality">মীরসরাই পৌরসভা (Mirsharai Municipality)</option><option value="Nazirhat Municipality">নাজিরহাট পৌরসভা (Nazirhat Municipality)</option><option value="Patiya Municipality">পটিয়া পৌরসভা (Patiya Municipality)</option><option value="Raozan Municipality">রাউজান পৌরসভা (Raozan Municipality)</option><option value="Sandwip Municipality">সন্দ্বীপ পৌরসভা (Sandwip Municipality)</option><option value="Satkania Municipality">সাতকানিয়া  পৌরসভা(Satkania Municipality)</option>';
    }
    if (DisList == "Cumilla") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Cumilla City Corporation">কুমিল্লা সিটি কর্পোরেশন (Cumilla City Corporation)</option><option value="Baruara Municipality">বরুড়া পৌরসভা (Baruara Municipality)</option><option value="Chandina Municipality">চান্দিনা পৌরসভা (Chandina Municipality)</option><option value="Chauddagram Municipality">চৌদ্দগ্রাম পৌরসভা (Chauddagram Municipality)</option><option value="Debidwar Municipality">দেবিদ্বার পৌরসভা (Debidwar Municipality)</option><option value="Daudkandi Municipality">দাউদকান্দি পৌরসভা (Daudkandi Municipality)</option><option value="Homna Municipality">হোমনা পৌরসভা (Homna Municipality)</option><option value="Laksham Municipality">লাকসাম পৌরসভা (Laksham Municipality)</option><option value="Nangalkot Municipality">নাঙ্গলকোট পৌরসভা (Nangalkot Municipality)</option>';
    }
    if (DisList == "Cox's Bazar") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Chakaria Municipality">চকরিয়া পৌরসভা (Chakaria Municipality)</option><option value="Cox\'s Bazar Municipality">কক্সবাজার পৌরসভা (Cox\'s Bazar Municipality)</option><option value="Maheshkhali Municipality">মহেশখালী পৌরসভা (Maheshkhali Municipality)</option><option value="Teknaf Municipality">টেকনাফ পৌরসভা (Teknaf Municipality)</option>';
    }
    if (DisList == "Feni") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Chhagalnaiya Municipality">ছাগলনাইয়া পৌরসভা (Chhagalnaiya Municipality)</option><option value="Daganbhuiyan Municipality">দাগনভূঞা পৌরসভা (Daganbhuiyan Municipality)</option><option value="Feni Municipality">ফেনী পৌরসভা (Feni Municipality)</option><option value="Parshuram Municipality">পরশুরাম পৌরসভা (Parshuram Municipality)</option><option value="Sonagazi Municipality">সোনাগাজী পৌরসভা (Sonagazi Municipality)</option>';
    }
    if (DisList == "Khagrachhari") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Khagrachhari Municipality">খাগড়াছড়ি পৌরসভা (Khagrachhari Municipality)</option><option value="Ramgarh Municipality">রামগড় পৌরসভা (Ramgarh Municipality)</option><option value="Matiranga Municipality">মাটিরাঙ্গা পৌরসভা (Matiranga Municipality)</option>';
    }
    if (DisList == "Lakshmipur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Lakshmipur Municipality">লক্ষ্মীপুর পৌরসভা (Lakshmipur Municipality)</option><option value="Raipur Municipality">রায়পুর পৌরসভা (Raipur Municipality)</option><option value="Ramganj Municipality">রামগঞ্জ পৌরসভা (Ramganj Municipality)</option><option value="Ramgoti Municipality">রামগতি পৌরসভা (Ramgoti Municipality)</option>';
    }
    if (DisList == "Noakhali") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bashurhat Municipality">বসুরহাট পৌরসভা (Bashurhat Municipality)</option><option value="Chatkhil Municipality">চাটখিল পৌরসভা (Chatkhil Municipality)</option><option value="Chowmuhani Municipality">চৌমুহনী পৌরসভা (Chowmuhani Municipality)</option><option value="Hatia Municipality">হাতিয়া পৌরসভা (Hatia Municipality)</option><option value="Kabirhat Municipality">কবিরহাট পৌরসভা (Kabirhat Municipality)</option><option value="Noakhali Municipality">নোয়াখালী পৌরসভা (Noakhali Municipality)</option><option value="Senbagh Municipality">সেনবাগ পৌরসভা (Senbagh Municipality)</option><option value="Sonaimuri Municipality">সোনাইমুড়ী পৌ (Sonaimuri Municipality)</option>';
    }
    if (DisList == "Rangamati") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Rangamati Municipality">রাঙ্গামাটি পৌরসভা (Rangamati Municipality)</option><option value="Baghachari Municipality">বাঘাইছড়ি পৌরসভা (Baghaichari Municipality)</option>';
    }

    //Dhaka Division
    if (DisList == "Dhaka") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Dhaka North City Corporation">ঢাকা উত্তর সিটি কর্পোরেশন (Dhaka North City Corporation)</option><option value="Dhaka South City Corporation">ঢাকা দক্ষিণ সিটি কর্পোরেশন (Dhaka South City Corporation)</option><option value="Dhamrai Municipality">ধামরাই পৌরসভা (Dhamrai Municipality)</option><option value="Dohar Municipality">দোহার পৌরসভা (Dohar Municipality)</option><option value="Savar Municipality">সাভার পৌরসভা (Savar Municipality)</option>';
    }

    if (DisList == "Faridpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bhanga Municipality">ভাঙ্গা পৌরসভা (Bhanga Municipality)</option><option value="Boalmari Municipality">বোয়ালমারী পৌরসভা (Boalmari Municipality)</option><option value="Faridpur Municipality">ফরিদপুর পৌরসভা (Faridpur Municipality)</option><option value="Nagarkanda Municipality">নগরকান্দা পৌরসভা (Nagarkanda Municipality)</option>';
    }
    if (DisList == "Gazipur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Gazipur City Corporation">গাজীপুর সিটি কর্পোরেশন  (Gazipur City Corporation)</option><option value="Kaliganj Municipality">কালীগঞ্জ পৌরসভা (Kaliganj Municipality)</option><option value="Sreepur Municipality">শ্রীপুর পৌরসভা (Sreepur Municipality)</option><option value="Tongi Municipality">টঙ্গী পৌরসভা (Tongi Municipality)</option>';
    }
    if (DisList == "Gopalganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Gopalganj Municipality">গোপালগঞ্জ পৌরসভা (Gopalganj Municipality)</option><option value="Kotalipara Municipality">কোটালীপাড়া  পৌরসভা (Kotalipara Municipality)</option><option value="Muksudpur Municipality">মুকসুদপুর পৌরসভা  (Muksudpur Municipality)</option><option value="Tungipara Municipality">টুংগীপাড়া পৌরসভা (Tungipara Municipality)</option>';
    }
    if (DisList == "Kishoreganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bajitpur Municipality">বাজিতপুর পৌরসভা (Bajitpur Municipality)</option><option value="Bhairab Municipality">ভৈরব পৌরসভা (Bhairab Municipality)</option><option value="Hossainpur Municipality">হোসেনপুর পৌরসভা (Hossainpur Municipality)</option><option value="Karimganj Municipality">করিমগঞ্জ পৌরসভা (Karimganj Municipality)</option><option value="Katiadi Municipality">কাটিয়াদী পৌরসভা (Katiadi Municipality)</option><option value="Kishoreganj Municipality">কিশোরগঞ্জ পৌরসভা (Kishoreganj Municipality)</option><option value="Kuliachar Municipality">কুলিয়ারচর পৌরসভা (Kuliachar Municipality)</option><option value="Pakundia Municipality">পাকুন্দিয়া পৌরসভা (Pakundia Municipality)</option>';
    }
    if (DisList == "Madaripur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Kalkini Municipality">কালকিনি পৌরসভা (Kalkini Municipality)</option><option value="Madaripur Municipality">মাদারীপুর পৌরসভা (Madaripur Municipality)</option><option value="Rajoir Municipality">রাজৈর পৌরসভা (Rajoir Municipality)</option><option value="Shibchar Municipality">শিবচর পৌরসভা (Shibchar Municipality)</option>';
    }
    if (DisList == "Manikganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Manikganj Municipality">মানিকগঞ্জ পৌরসভা (Manikganj Municipality)</option><option value="Singair Municipality">সিঙ্গাইর (Singair Municipality)</option>';
    }
    if (DisList == "Munshiganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Mirakadima Municipality">মীরকাদিম পৌরসভা (Mirakadima Municipality)</option><option value="Munshiganj Municipality">মুন্সিগঞ্জ পৌরসভা (Munshiganj Municipality)</option>';
    }
    if (DisList == "Narayanganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Narayanganj City Corporation">নারায়নগঞ্জ সিটি কর্পোরেশন (Narayanganj City Corporation)</option><option value="Araihazar Municipality">আড়াইহাজার পৌরসভা (Araihazar Municipality) </option><option value="Gopaladi Municipality">গোপালদি পৌরসভা (Gopaladi Municipality)</option><option value="Kanchan Municipality">কাঞ্চন পৌরসভা (Kanchan Municipality)</option><option value="Sonargaon Municipality">সোনারগাঁ পৌরসভা (Sonargaon Municipality)</option><option value="Tarabo Municipality">তারাবো পৌরসভা (Tarabo Municipality)</option>';
    }
    if (DisList == "Narsingdi") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Ghorashal Municipality">ঘোড়াশাল পৌরসভা (Ghorashal Municipality)</option><option value="Madhabdi Municipality">মাধবদী পৌরসভা (Madhabdi Municipality)</option><option value="Monohardi Municipality">মনোহরদী পৌরসভা (Monohardi Municipality)</option><option value="Narsingdi Municipality">নরসিংদী পৌরসভা (Narsingdi Municipality)</option><option value="Raipura Municipality">রায়পুরা পৌরসভা (Raipura Municipality)</option><option value="Shibpur Municipality">শিবপুর পৌরসভা (Shibpur Municipality)</option>';
    }
    if (DisList == "Rajbari") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Goalanda Municipality">গোয়ালন্দ পৌরসভা (Goalanda Municipality)</option><option value="Pangsha Municipality">পাংশা পৌরসভা (Pangsha Municipality)</option><option value="Rajbari Municipality">রাজবাড়ী পৌরসভা (Rajbari Municipality)</option>';
    }
    if (DisList == "Shariatpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bhedarganj Municipality">ভেদরগঞ্জ পৌরসভা (Bhedarganj Municipality)</option><option value="Damudya Municipality">ডামুড্যা পৌরসভা (Damudya Municipality</option><option value="Gosairhat Municipality">গোসাইরহাট পৌরসভা (Gosairhat Municipality)</option><option value="Jazeera Municipality">জাজিরা পৌরসভা (Jazeera Municipality)</option><option value="Naria Municipality">নড়িয়া পৌরসভা (Naria Municipality)</option><option value="Shariatpur Municipality">শরীয়তপুর পৌরসভা (Shariatpur Municipality)</option>';
    }
    if (DisList == "Tangail") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Basail Municipality">বাসাইল পৌরসভা (Basail Municipality)</option><option value="Bhuapur Municipality">ভুয়াপুর পৌরসভা (Bhuapur Municipality)</option><option value="Dhanbari Municipality">ধনবাড়ী পৌরসভা (Dhanbari Municipality)</option><option value="Elenga Municipality">এলেঙ্গা পৌরসভা (Elenga Municipality)</option><option value="Ghatail Municipality">ঘাটাইল পৌরসভা (Ghatail Municipality)</option><option value="Gopalpur Municipality">গোপালপুর পৌরসভা (Gopalpur Municipality)</option><option value="Kalihati Municipality">কালাহাতি পৌরসভা (Kalihati Municipality)</option><option value="Madhupur Municipality">মধুপুর পৌরসভা (Madhupur Municipality)</option><option value="Mirzapur Municipality">মির্জাপুর পৌরসভা (Mirzapur Municipality)</option><option value="Sakhipur Municipality">সখিপুর পৌরসভা (Sakhipur Municipality)</option><option value="Tangail Municipality">টাঙ্গাইল পৌরসভা (Tangail Municipality)</option>';
    }
    // Khulna Division
    if (DisList == "Bagerhat") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bagerhat Municipality">বাগেরহাট পৌরসভা (Bagerhat Municipality)</option><option value="Mongla Municipality">মংলা পৌরসভা (Mongla Municipality)</option><option value="Morrelganj Municipality">মোরেলগঞ্জ পৌরসভা (Morrelganj Municipality)</option>';
    }
    if (DisList == "Chuadanga") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Alamdanga Municipality">আলমডাঙ্গা পৌরসভা (Alamdanga Municipality)</option><option value="Chuadanga Municipality">চুয়াডাঙ্গা পৌরসভা (Chuadanga Municipality)</option><option value="Darsana Municipality">দর্শনা পৌরসভা (Darsana Municipality)</option><option value="Jibannagar Municipality">জীবননগর পৌরসভা (Jibannagar Municipality)</option>';
    }
    if (DisList == "Jashore") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bagherpara Municipality">বাঘারপাড়া পৌরসভা (Bagherpara Municipality)</option><option value="Benapole Municipality">বেনাপোল পৌরসভা (Benapole Municipality)</option><option value="Chaugachha Municipality">চৌগাছা পৌরসভা (Chaugachha Municipality)</option><option value="Jashore Municipality">যশোর পৌরসভা (Jashore Municipality)</option><option value="Jhikargacha Municipality">ঝিকরগাছা পৌরসভা (Jhikargacha Municipality)</option><option value="Keshabpur Municipality">কেশবপুর পৌরসভা (Keshabpur Municipality)</option><option value="Manirampur Municipality">মণিরামপুর পৌরসভা (Manirampur Municipality)</option><option value="Noapara Municipality">নওয়াপাড়া পৌরসভা (Noapara Municipality)</option>';
    }
    if (DisList == "Jhenaidah") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Jhenaidah Municipality">ঝিনাইদহ পৌরসভা (Jhenaidah Municipality)</option><option value="Kaliganj Municipality">কালীগঞ্জ পৌরসভা (Kaliganj Municipality)</option><option value="Kotchandpur Municipality">কোটচাঁদপুর পৌরসভা (Kotchandpur Municipality)</option><option value="Maheshpur Municipality">মহেশপুর পৌরসভা (Maheshpur Municipality)</option><option value="Shailkupa Municipality">শৈলকুপা পৌরসভা (Shailkupa Municipality)</option>';
    }
    if (DisList == "Khulna") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Khulna City Corporation">খুলনা সিটি কর্পোরেশন (Khulna City Corporation)</option><option value="Dakop Municipality">দাকোপ পৌরসভা (Dakop Municipality)</option><option value="Paikgasa Municipality">পাইকগাছা পৌরসভা (Paikgasa Municipality)</option>';
    }
    if (DisList == "Kustia") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bheramara Municipality">ভেড়ামারা পৌরসভা (Bheramara Municipality)</option><option value="Khoksa Municipality">খোকসা পৌরসভা (Khoksa Municipality)</option><option value="Kumarkhali Municipality">কুমারখালী পৌরসভা (Kumarkhali Municipality)</option><option value="Kushtia Municipality">কুষ্টিয়া পৌরসভা (Kushtia Municipality)</option><option value="Mirpur Municipality">মিরপুর পৌরসভা (Mirpur Municipality)</option>';
    }
    if (DisList == "Magura") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Magura Municipality">মাগুরা পৌরসভা (Magura Municipality)</option>';
    }
    if (DisList == "Meherpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Gangni Municipality">গাংনী পৌরসভা (Gangni Municipality)</option><option value="Meherpur Municipality">মেহেরপুর পৌরসভা (Meherpur Municipality)</option>';
    }
    if (DisList == "Narail") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Lohagara Municipality">লোহাগড়া পৌরসভা (Lohagara Municipality)</option><option value="Kalia Municipality">কালিয়া পৌরসভা (Kalia Municipality)</option><option value="Narail Municipality">নড়াইল পৌরসভা (Narail Municipality)</option>';
    }
    if (DisList == "Satkhira") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Kalaroa Municipality">কলারোয়া পৌরসভা (Kalaroa Municipality)</option><option value="Satkhira Municipality">সাতক্ষীরা পৌরসভা (Satkhira Municipality)</option>';
    }

    //Mymensingh Division
    if (DisList == "Mymensingh") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Mymensingh City Corporation">ময়মনসিংহ সিটি কর্পোরেশন (Mymensingh City Corporation)</option><option value="Bhaluka Municipality">ভালুকা পৌরসভা (Bhaluka Municipality)</option><option value="Fulbaria Municipality">ফুলবাড়ীয়া পৌরসভা (Fulbaria Municipality)</option><option value="Gafargaon Municipality">গফরগাঁও পৌরসভা (Gafargaon Municipality)</option><option value="Gauripur Municipality">গৌরীপুর পৌরসভা (Gauripur Municipality)</option><option value="Haluaghat Municipality">হালুয়াঘাট পৌরসভা (Haluaghat Municipality)</option><option value="Ishwarganj Municipality">ঈশ্বরগঞ্জ পৌরসভা (Ishwarganj Municipality)</option><option value="Muktagacha Municipality">মুক্তাগাছা পৌরসভা (Muktagacha Municipality)</option><option value="Nandail Municipality">নান্দাইল পৌরসভা (Nandail Municipality)</option><option value="Phulpur Municipality">ফুলপুর পৌরসভা (Phulpur Municipality)</option><option value="Trishal Municipality">ত্রিশাল পৌরসভা (Trishal Municipality)</option>';
    }
    if (DisList == "Netrokona") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Durgapur Municipality">দূর্গাপুর পৌরসভা (Durgapur Municipality)</option><option value="Kendua Municipality">কেন্দুয়া পৌরসভা (Kendua Municipality)</option><option value="Madan Municipality">মদন পৌরসভা (Madan Municipality)</option><option value="Mohanganj Municipality">মোহনগঞ্জ পৌরসভা (Mohanganj Municipality)</option><option value="Netrokona  Municipality">নেত্রকোণা পৌরসভা (Netrokona  Municipality)</option>';
    }
    if (DisList == "Jamalpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Bakshiganj Municipality">বকশীগঞ্জ পৌরসভা (Bakshiganj Municipality)</option><option value="Dewanganj Municipality">দেওয়ানগঞ্জ পৌরসভা (Dewanganj Municipality)</option><option value="Hazrabari Municipality">হাজরাবাড়ী পৌরসভা (Hazrabari Municipality)</option><option value="Islampur Municipality">ইসলামপুর পৌরসভা (Islampur Municipality)</option><option value="Jamalpur Municipality">জামালপুর পৌরসভা (Jamalpur Municipality)</option><option value="Madarganj  Municipality">মাদারগঞ্জ পৌরসভা (Madarganj  Municipality)</option><option value="Melandaha  Municipality">মেলান্দহ পৌরসভা (Melandaha  Municipality)</option><option value="Sharishabari  Municipality">সরিষাবাড়ী পৌরসভা (Sharishabari  Municipality)</option>';
    }
    if (DisList == "Sherpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Nalitabari Municipality">নালিতাবাড়ি পৌরসভা (Nalitabari Municipality)</option><option value="Nakla Municipality">নকলা পৌরসভা (Nakla Municipality)</option><option value="Sherpur Municipality">শেরপুর পৌরসভা (Sherpur Municipality)</option><option value="Sreebardi Municipality">শ্রীবর্দী পৌরসভা (Sreebardi Municipality)</option>';
    }
    ...
    if (DisList == "Dinajpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Biral Municipality">বিরল পৌরসভা (Biral Municipality)</option><option value="Birampur Municipality">বিরামপুর পৌরসভা (Birampur Municipality)</option><option value="Birganj Municipality">বীরগঞ্জ পৌরসভা (Birganj Municipality)</option><option value="Dinajpur Municipality">দিনাজপুর পৌরসভা (Dinajpur Municipality)</option><option value="Ghoraghat Municipality">ঘোড়াঘাট পৌরসভা (Ghoraghat Municipality)</option><option value="Hakimpur Municipality">হাকিমপুর পৌরসভা (Hakimpur Municipality)</option><option value="Parbatipur Municipality">পার্বতীপুর পৌরসভা (Parbatipur Municipality)</option><option value="Phulbari Municipality">ফুলবাড়ী পৌরসভা (Phulbari Municipality)</option><option value="Setabganj Municipality">সেতাবগন্জ পৌরসভা (Setabganj Municipality)</option>';
    }
    if (DisList == "Gaibandha") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Gaibandha Municipality">গাইবান্ধা পৌরসভা (Gaibandha Municipality)</option><option value="Gobindaganj Municipality">গোবিন্দগঞ্জ পৌরসভা (Gobindaganj Municipality)</option><option value="Palashbari Municipality">পলাশবাড়ী পৌরসভা (Palashbari Municipality)</option><option value="Sundarganj Municipality">সুন্দরগঞ্জ পৌরসভা (Sundarganj Municipality)</option>';
    }
    if (DisList == "Kurigram") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Kurigram Municipality">কুড়িগ্রাম পৌরসভা (Kurigram Municipality)</option><option value="Nageswari Municipality">নাগেশ্বরী পৌরসভা (Nageswari Municipality)</option><option value="Ulipur Municipality">উলিপুর পৌরসভা (Ulipur Municipality)</option>';
    }
    if (DisList == "Lalmonirhat") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Lalmonirhat Municipality">লালমনিরহাট পৌরসভা (Lalmonirhat Municipality)</option><option value="Patgram Municipality">পাটগ্রাম পৌরসভা (Patgram Municipality)</option>';
    }
    if (DisList == "Nilphamari") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Domar Municipality">ডোমার  পৌরসভা (Domar Municipality)</option><option value="Jaldhaka Municipality">জলঢাকা পৌরসভা (Jaldhaka Municipality)</option><option value="Nilphamari Municipality">নীলফামারী পৌরসভা (Nilphamari Municipality)</option><option value="Saidpur Municipality">সৈয়দপুর পৌরসভা (Saidpur Municipality)</option>';
    }
    if (DisList == "Panchagarh") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Boda Municipality">বোদা পৌরসভা (Boda Municipality)</option><option value="Debiganj Municipality">দেবীগঞ্জ পৌরসভা (Debiganj Municipality)</option><option value="Panchagarh Municipality">পঞ্চগড় পৌরসভা (Panchagarh Municipality)</option>';
    }
    if (DisList == "Rangpur") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Rangpur City Corporation">রংপুর সিটি কর্পোরেশন (Rangpur City Corporation)</option><option value="Badarganj Municipality">বদরগঞ্জ পৌরসভা (Badarganj Municipality)</option><option value="Haragachh Municipality">হারাগাছ পৌরসভা (Haragachh Municipality)</option><option value="Pirganj Municipality">পীরগঞ্জ পৌরসভা (Pirganj Municipality)</option>';
    }
    if (DisList == "Thakurgaon") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Pirganj Municipality">পীরগঞ্জ পৌরসভা (Pirganj Municipality)</option><option value="Ranisankail Municipality">রাণীশংকৈল পৌরসভা (Ranisankail Municipality)</option><option value="Thakurgaon Municipality">ঠাকুরগাঁও পৌরসভা (Thakurgaon Municipality)</option>';
    }

    //Sylhet Division
    if (DisList == "Habiganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Azmiriganj Municipality">আজমিরীগঞ্জ পৌরসভা (Azmiriganj Municipality)</option><option value="Chunarughat Municipality">চুনারুঘাট পৌরসভা (Chunarughat Municipality)</option><option value="Habiganj Municipality">হবিগঞ্জ পৌরসভা (Habiganj Municipality)</option><option value="Madhabpur Municipality">মাধবপুর পৌরসভা (Madhabpur Municipality)</option><option value="Nabiganj Municipality">নবীগঞ্জ পৌরসভা (Nabiganj Municipality)</option><option value="Shayestaganj Municipality">শায়েস্তাগঞ্জ পৌরসভা (Shayestaganj Municipality)</option>';
    }
    if (DisList == "Moulvibazar") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Barlekha Municipality">বড়লেখা পৌরসভা (Barlekha Municipality)</option><option value="Kamalganj Municipality">কমলগঞ্জ পৌরসভা (Kamalganj Municipality)</option><option value="Kulaura Municipality">কুলাউড়া পৌরসভা (Kulaura Municipality)</option><option value="Moulvibazar Municipality">মৌলভীবাজার পৌরসভা (Moulvibazar Municipality)</option><option value="Sreemongal Municipality">শ্রীমঙ্গল পৌরসভা (Sreemongal Municipality)</option>';
    }
    if (DisList == "Sunamganj") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Chhatak Municipality">ছাতক পৌরসভা (Chhatak Municipality)</option><option value="Derai Municipality">দিরাই পৌরসভা (Derai Municipality)</option><option value="Jagannathpur Municipality">জগন্নাথপুর পৌরসভা (Jagannathpur Municipality)</option><option value="Sunamganj Municipality">সুনামগঞ্জ পৌরসভা (Sunamganj Municipality)</option>';
    }
    if (DisList == "Sylhet") {
        var adminList =
            '<option disabled selected>Select Administration</option><option value="Sylhet City Corporation">সিলেট সিটি কর্পোরেশন (Sylhet City Corporation)</option><option value="Beanibazar Municipality">বিয়ানিবাজার পৌরসভা (Beanibazar Municipality)</option><option value="Golapganj Municipality">গোলাপগঞ্জ পৌরসভা (Golapganj Municipality)</option><option value="Kanaighat Municipality">কানাইঘাট পৌরসভা (Kanaighat Municipality)</option><option value="Zakiganj Municipality">জকিগঞ্জ পৌরসভা (Zakiganj Municipality)</option>';
    }
