        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img src="{{ $participant->avatar }}" alt="Avatar" class="rounded-circle avatar avatar-md" />
                        </td>
                        <td>
                            {{ $participant->name }}
                        </td>
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-center justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ $participant->avatar }}" alt="Participant Avatar | {{ $participant->name }}"
                                class="rounded" />
                        </div>
                        <small class="text-success fw-medium"><i class='bx bx-dollar-circle me-1'></i>Success</small>
                    </div>
